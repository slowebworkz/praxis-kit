 ...
 * snapshots/gzip.json.
 *
 * Own copy of tree-shaking-tests' scripts/gzip.ts, not extracted into the shared module: this
 * logic is generic and mechanical (no repo-specific knowledge — unlike workspace-resolution.ts's
 * alias map), so a second copy carries no real drift risk.
 *
