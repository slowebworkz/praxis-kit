...
// silentDiagnostics suppresses console output so violation paths don't flood bench output.
// The evaluate() static method is used where report overhead should be excluded entirely.
