// Generic iteration algorithms over `Iterable`s and DOM-style `item(i)`
// collections. Already large — keep it to genuinely shared primitives; a helper
// with one call site belongs next to that call site, not here.
