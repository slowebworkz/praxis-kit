/**
 * Three distinct semantics — do not conflate them:
 *
 * Execution order:   'chain'        — child fires first; slot fires unless defaultPrevented.
 * Concatenation:     'concat'       — slot classes precede child classes.
 * Override:          'shallow-merge' — child wins on style key conflicts; 'child-wins' replaces outright.
 */
